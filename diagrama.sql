...
CREATE TABLE IF NOT EXISTS `ventas_jugos`.`tb_clientes` (
  ...
  `CP` VARCHAR(50) NULL DEFAULT NULL,
  `FECHA_NAC` DATE NULL DEFAULT NULL,
  `EDAD` SMALLINT NULL DEFAULT NULL,
  `SEXO` VARCHAR(1) NULL DEFAULT NULL,
  `LIMITE_CRED` FLOAT NULL DEFAULT NULL,
  `VOLUMEN_COMP` FLOAT NULL DEFAULT NULL,
  `PRIMERA_COMP` BIT(1) NULL DEFAULT NULL,
  PRIMARY KEY (`DNI`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `ventas_jugos`.`tb_vendedor` (
  ...
  `FECHAS_ADMISION` DATE NULL DEFAULT NULL,
